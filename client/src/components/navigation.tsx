  ...
  return (
    <nav className="absolute top-0 left-0 right-0 z-50 bg-transparent">
      <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div className="flex flex-col items-end space-y-2 w-auto">
          <a 
            href="tel:5757581772" 
          ...
          <a 
            ...
            className="bg-casa-blue text-white px-3 py-1 rounded-sm text-sm font-medium tracking-wide hover:bg-casa-blue/90 smooth-transition text-center block w-full"
          >
            Check Availability
          </a>
        </div>
